...
const MyPage = () => {
  return (
    <section className={cn("w-full h-[calc(100svh-52px)] flex-center", "tablet:h-svh")}>
      <div className="w-full h-full mx-4 tablet:mx-[60px] min-w-[343px] max-w-[940px] max-h-[600px] tablet:max-h-[720px] flex-col-center gap-7">
        <div
          className={cn(
            "w-full h-full px-5 bg-background-primary rounded-[20px]  flex-col-center gap-[35px]",
            "tablet:px-[45px]",
          )}
        >
